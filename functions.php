...
add_action('rest_api_init', function () {
    ...
    register_rest_route('ffi/v1', '/homepage', [
        'methods'             => 'GET',
        'callback'            => function () {
            $keys = ['about_eyebrow','about_heading','about_stat_number','about_stat_label','about_image','about_paragraphs','vm_eyebrow','vm_heading','vm_intro','vision_text','mission_text','sdg_pillars','programs_eyebrow','programs_heading','programs_description','programs_stats','programs_progress_bars','programs_initiatives','partners','hero_slides'];
            $acf = [];
            foreach ($keys as $key) {
                $acf[$key] = get_option('options_' . $key, false);
            }
            return rest_ensure_response(['acf' => $acf]);
        },
