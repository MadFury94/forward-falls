...
const ProgramsPage = () => {
    return (
        <main className="min-h-screen font-poppins">
            ...
            {/* Page Header */}
            <section className="bg-primary-green text-white py-24 relative overflow-hidden">
                <div className="container mx-auto px-6 relative z-10">
                    <span className="text-white font-bold tracking-[0.3em] uppercase text-sm mb-4 block">Our Impact</span>
                    <h1 className="text-5xl md:text-6xl font-bold uppercase mb-6">Programs & <span className="text-primary-yellow">Initiatives</span></h1>
            ...
            <section className="py-24 bg-light-bg">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold mb-4 text-dark-grey uppercase">Expanding Our <span className="text-primary-yellow">Reach</span></h2>
                        <div className="w-20 h-1 bg-primary-green mx-auto"></div>
                    </div>

                    <div className="grid lg:grid-cols-2 gap-12">
                        {/* Activism */}
                        <div className="bg-white p-10 rounded-3xl shadow-sm border-b-8 border-primary-green relative overflow-hidden group">
                        ...
                        {/* Life Lessons */}
                        <div className="bg-white p-10 rounded-3xl shadow-sm border-b-8 border-primary-yellow relative overflow-hidden group">
                            <div className="relative z-10">
                        ...
                        {/* Outreach */}
                        <div className="bg-white p-10 rounded-3xl shadow-sm border-b-8 border-secondary-orange relative overflow-hidden group">
                            <div className="relative z-10">
                        ...
                        {/* Fellowship */}
                        <div className="bg-dark-grey p-10 rounded-3xl shadow-sm border-b-8 border-primary-green relative overflow-hidden group text-white">
                            <div className="relative z-10">
